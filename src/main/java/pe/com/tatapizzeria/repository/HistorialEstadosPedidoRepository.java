...
public interface HistorialEstadosPedidoRepository extends JpaRepository<HistorialEstadosPedidoEntity, Long> {
    ...
    List<HistorialEstadosPedidoEntity> findByPedidoIdOrderByFechaHoraCambioAsc(@Param("idPedido") Long idPedido);
    ...
    List<HistorialEstadosPedidoEntity> findLastEstadoByPedidoId(@Param("idPedido") Long idPedido);
